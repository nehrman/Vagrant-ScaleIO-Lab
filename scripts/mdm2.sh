...
if [ "${CLUSTERINSTALL}" == "True" ]; then
  ...
  scli --add_sds --mdm_ip ${FIRSTMDMIP} --sds_ip ${FIRSTMDMIP} --device_path ${DEVICE} --sds_name mdm01 --protection_domain_name pdomain
  scli --add_sds --mdm_ip ${FIRSTMDMIP} --sds_ip ${SECONDMDMIP} --device_path ${DEVICE} --sds_name mdm02 --protection_domain_name pdomain
  scli --add_sds --mdm_ip ${FIRSTMDMIP} --sds_ip ${TBIP} --device_path ${DEVICE} --sds_name tb01 --protection_domain_name pdomain
